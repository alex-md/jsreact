...
console.log("Hello from the playground!");`,currentTab:"html",autoReload:!0,consoleVisible:!1,libraries:[]},l=new u,p=new m(l);new y(d,p);new h(d,p);document.getElementById("toggle-console").addEventListener("click",()=>{l.toggle(d)});document.addEventListener("DOMContentLoaded",()=>{const r=document.getElementById("library-button"),e=document.getElementById("library-menu");r.addEventListener("click",t=>{t.stopPropagation(),e.classList.toggle("visible")}),document.addEventListener("click",()=>{e.classList.remove("visible")}),e.addEventListener("click",t=>{t.stopPropagation()})});
