...
const navItems = [
    { href: '/pages/minify', text: 'Minify' },
    { href: '/pages/generator', text: 'AI Name Generator' },
...
function getNavigationPath(path) {
    return path;  // Now using absolute paths, so we can return the path directly
}
...
export function createNavbar() {
    ...
    logoLink.href = '/';  // Updated to absolute path
    ...
    // Use Vite's asset handling for logo
