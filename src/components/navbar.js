...
function setupSearch(searchInput, searchResults) {
    const allTools = [
        { name: "Minifier", href: "/pages/minify/", description: "Minify JavaScript, CSS, and HTML code" },
        { name: "Cleaner", href: "/pages/clean/", description: "Clean and format text content" },
        { name: "Insert Tool", href: "/pages/insert/", description: "Insert text at specific positions" },
        { name: "Keywords", href: "/pages/keyword/", description: "Analyze keyword density and distribution" },
        { name: "Generator", href: "/pages/generator/", description: "Generate creative domain names" },
        { name: "Diff Checker", href: "/pages/diff/", description: "Compare text differences" },
        { name: "Expression Tester", href: "/pages/expression/", description: "Test regular expressions" },
        { name: "Playground", href: "/pages/playground/", description: "Live HTML, CSS, JS editor" },
        { name: "QR Code", href: "/pages/qr/", description: "Generate QR codes" },
        { name: "Speech Tools", href: "/pages/speech/", description: "Text to speech conversion" },
        { name: "Domain Appraisal", href: "/pages/domain/", description: "Value domain names" },
        { name: "OSRS Flipper", href: "/pages/osrs/", description: "OSRS item price checker" },
    ];
